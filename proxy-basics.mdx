...
You can ask FetchFox to try multiple proxies at once. Simply pass in an array of strings as the `proxy` parameter. FetchFox will launch concurrent visits for each proxy you pass in, and use the first valid response it gets.
