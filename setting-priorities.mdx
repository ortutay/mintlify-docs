...
- `high` can be used to mark certain URL patterns as high priority. If this field is defined, then FetchFox will prioritize visiting URLs that match _any_ of the patterns in the list.
- `low` can be used to mark certain URL patterns as low priority. If this field is defined, then FetchFox will place low priority on visiting URLs that match _any_ of the patterns in the list.
